                ...
                <div key={i}>
                  ...
                  {isLong ? (
                    <textarea
                      ...
                      rows={3}
                      className="w-full px-2.5 py-1.5 text-[11px] border border-border rounded-[var(--radius)] bg-white text-slate focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500/20 resize-y"
                    ...
                    <input
                      ...
                      value={values[field] ?? ""}
                      onChange={(e) => handleChange(field, e.target.value)}
                      className="w-full px-2.5 py-1.5 text-[11px] border border-border rounded-[var(--radius)] bg-white text-slate focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500/20"
                      placeholder={`Enter ${field.toLowerCase()}...`}
                    />
                  )}
                </div>
