...
/**
 * Benin Construction Trades
 *
 * Workers in Benin's construction industry operate in a largely
 * informal market, similar to Togo. There are no licensing
 * requirements, mandatory trade unions, or formal certification
 * systems for most trades. Hiring is based on personal referral,
 * reputation, and demonstrated skill.
 *
 * Rates are in CFA francs (XOF) per day (journalier system).
 * Most workers are paid daily or weekly in cash. Rates vary by
 * experience, reputation, and whether the project is in Cotonou
 * (higher rates) or the interior (lower rates). Rates in Benin
 * are generally comparable to Togo, slightly higher in Cotonou
 * due to higher cost of living.
 */
export const BENIN_TRADES: TradeDefinition[] = [
  {
    id: "benin-macon",
    name: "Mason",
    localName: "Macon",
    description:
      "The core trade in Beninese construction. Macons lay concrete blocks (agglo), mix and pour concrete, apply plaster (enduit), and handle most general masonry work. An experienced macon is often also the chef de chantier (site foreman). Quality varies enormously — a skilled macon produces straight, level walls with consistent mortar joints, while an unskilled one creates crooked walls that waste materials and compromise structural integrity.",
    phases: ["BUILD"],
    typicalRateRange: { low: 5000, high: 15000, unit: "day" },
    licensingRequired: false,
    licensingNotes:
      "No formal licensing exists in Benin. Masons learn through apprenticeship, typically starting as manoeuvres and working their way up over 3-5 years. Hire based on referrals and by visiting their previous work.",
    criticalSkills: [
  ...
  },
  {
    ...
    localName: "Couvreur",
    description:
      "Installs roofing sheets (bac aluminium or galvanized steel tole) on the charpente, including ridge caps, flashing, and gutters. In Benin, roofing is a relatively quick phase but must be done correctly to prevent leaks during the heavy rainy seasons. The couvreur works at height and must handle large, sometimes sharp-edged metal sheets safely.",
    phases: ["BUILD"],
    typicalRateRange: { low: 5000, high: 12000, unit: "day" },
    licensingRequired: false,
    licensingNotes:
  ...
  },
  {
    ...
    localName: "Plombier",
    description:
      "Installs PVC water supply pipes, drainage pipes, sanitary fixtures (toilets, sinks, showers), and connects the water storage and pumping system. Plumbing in Benin typically uses PVC for all pipe runs. The plombier also connects the building to the fosse septique (septic system) and, where available, the municipal water supply (SONEB).",
    phases: ["BUILD", "VERIFY"],
    typicalRateRange: { low: 6000, high: 15000, unit: "day" },
    licensingRequired: false,
    licensingNotes:
  ...
  {
    id: "benin-electricien",
    name: "Electrician",
    localName: "Electricien",
    description:
      "Installs all electrical wiring in conduit (gaine), switches, outlets, the breaker panel (tableau electrique), and coordinates the SBEE grid connection. A competent electricien understands circuit sizing, proper grounding (mise a la terre), and safety requirements. Faulty electrical work is a leading cause of house fires in West Africa.",
    phases: ["BUILD", "VERIFY"],
    typicalRateRange: { low: 6000, high: 15000, unit: "day" },
    licensingRequired: false,
    licensingNotes:
      "No formal licensing, but SBEE may require a certified electrician's attestation for new grid connections. The most important safety items are proper circuit breaker sizing, correct wire gauge for each circuit, and a functional earth/ground connection.",
    criticalSkills: [
      ...
      "SBEE meter connection coordination",
    ],
  },
  {
    id: "benin-carreleur",
    ...
    localName: "Carreleur",
    description:
      "Lays floor and wall tiles using cement adhesive. A skilled carreleur produces level surfaces with consistent joint widths and clean cuts around obstacles. Tiling is one of the most visible finish elements in a Beninese home — poor tile work is immediately noticeable and difficult to repair after the adhesive sets.",
    phases: ["BUILD"],
    typicalRateRange: { low: 5000, high: 12000, unit: "day" },
    licensingRequired: false,
    licensingNotes:
  ...
  },
  {
    ...
    localName: "Menuisier",
    description:
      "Custom-builds doors, windows, built-in furniture (placards), kitchen counters, and decorative wood elements. In Benin, most doors and windows are custom-made by a menuisier rather than bought off-the-shelf. The menuisier may also install aluminum window and door systems if they have the skill set. Cotonou and Porto-Novo have established menuiserie workshops.",
    phases: ["BUILD"],
    typicalRateRange: { low: 6000, high: 15000, unit: "day" },
    licensingRequired: false,
    licensingNotes:
