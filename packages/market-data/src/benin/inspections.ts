...
/**
 * Benin Construction Inspections
 *
 * Benin does not have a comprehensive formal building inspection
 * system comparable to the USA. Quality control relies on:
 *
 ...
 * 4. The Direction departementale du Cadre de Vie may conduct
 *    conformity checks for larger projects
 *
 * The inspections listed here represent the critical quality
 * checkpoints that SHOULD be performed, even though most are
 * informal. For diaspora builders managing remotely, these
 * checkpoints are essential — require timestamped photos of
 * rebar before every concrete pour as a minimum verification
 * standard.
 */
export const BENIN_INSPECTIONS: InspectionRequirement[] = [
  {
    id: "benin-insp-foundation-rebar",
  ...
  {
    id: "benin-insp-ring-beam-rebar",
    name: "Ring Beam Rebar Check",
    phase: "BUILD",
    milestone: "Ring beams poured (chainage haut)",
    description:
      "Verify the rebar and formwork for horizontal ring beams (chainages) that tie all walls together at lintel level and at the top of walls. Ring beams are critical structural elements that prevent walls from separating and distribute loads evenly.",
    inspector: "Architect or owner",
    checklistItems: [
  ...
  {
    id: "benin-insp-slab-rebar",
    name: "Slab Rebar Check",
    phase: "BUILD",
    milestone: "Slab poured (dalle)",
    description:
      "Inspect the reinforcement for the floor slab (dalle) or upper-floor slab (plancher) before the concrete pour. For solid slabs, verify the rebar mesh spacing and bar sizes. For hourdis (ribbed slab) systems, verify the poutrelles (ribs), hourdis blocks, and the top reinforcement mesh.",
    inspector: "Architect or owner",
    checklistItems: [
  ...
  {
    id: "benin-insp-roof-structure",
    name: "Roof Structure Check",
    phase: "BUILD",
    milestone: "Roof structure installed (charpente)",
    description:
      "Inspect the roof structure (charpente) before roofing sheets are installed. Verify that trusses or rafters are properly sized, spaced, and connected to the ring beam or slab. For wood charpente, check for anti-termite treatment. For steel charpente, check weld quality.",
    inspector: "Architect or owner",
    checklistItems: [
  ...
  {
    id: "benin-insp-electrical-safety",
    name: "Electrical Safety Check",
    phase: "BUILD",
    milestone: "Electrical installed",
    description:
      "Verify the electrical installation before walls are closed and before SBEE connection. Test all circuits, verify proper grounding (mise a la terre), and confirm that the breaker panel (tableau electrique) is correctly wired with appropriate circuit breaker sizing.",
    inspector: "Architect or owner",
    checklistItems: [
  ...
  {
    id: "benin-insp-final-reception",
    name: "Final Reception (Proces-verbal de reception)",
    phase: "VERIFY",
    milestone: "Proces-verbal de reception signed",
    description:
      "The formal reception of the completed building by the owner, ideally witnessed by the architect. The architect performs a comprehensive inspection and documents all findings in a proces-verbal de reception. Any deficiencies are listed as reserves that the builder must correct. This document has legal significance.",
    ...
    checklistItems: [
      ...
      "Water supply system (SONEB and/or tank) fully operational",
